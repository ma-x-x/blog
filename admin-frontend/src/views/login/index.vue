<template>
  <div class="login-container">
    ...
    >
      ...
      <!-- 验证码 -->
      <el-form-item>
        <JcRange :status="state.status" :valid-failed="state.validFailed" :success-fun="onSuccessFun"></JcRange>
      </el-form-item>
      ...
      <el-button
        ...
        :loading="loading"
        type="primary"
        style="width: 100%; margin-bottom: 30px; margin-top: "
...
const { loginForm, loginRules, loading, passwordType, capslockTooltipDisabled, showCopyright } = toRefs(state);
