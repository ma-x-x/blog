    ...
    <el-row :gutter="10">
      <el-col :span="10" :xs="24">
        <el-card class="box-card" shadow="always">
          ...
          <role ref="role" @role-click="handleRoleClick" />
        </el-card>
      </el-col>
      ...
      <el-col :span="6" :xs="24">
        <el-card class="box-card" shadow="always">
          <template #header>
            ...
            <el-tag v-if="role.id" type="success">
              <svg-icon color="green" icon-class="role" />
              {{ role.name }}
            </el-tag>
            <el-tag v-else type="warning" size="small">请选择角色</el-tag>
          </template>
          <menus ref="menu" :role="role" @menu-click="handleMenuClick" />
        </el-card>
      </el-col>
      ...
      <el-col :span="8" :xs="24">
        <el-card class="box-card" shadow="always">
          <template #header>
            ...
            <el-tag v-if="role.id" type="success" style="margin: 0 5px 0 0">
              <svg-icon color="green" icon-class="role" />
              {{ role.name }}
            </el-tag>
            <el-tag v-else type="warning" style="margin: 0 5px 0 0" size="small"> 请选择角色 </el-tag>

            <el-tag v-if="menu.id" type="success" size="small">
              <svg-icon color="red" icon-class="menu" />
              {{ menu.name }}
            </el-tag>
            <el-tag v-else type="warning" size="small"> 请选择菜单</el-tag>
          </template>
